...
class ProvenanceTracker:
    ...
    def record_label(
        ...
        self._provider_usage[provider_used] = self._provider_usage.get(provider_used, 0) + 1
    ...
    def wrap_label_generation(
        ...
        for cluster_id, items in clusters.items():
            ...
            try:
                raw_response = label_generator.provider_manager.generate_label(
                ...
                logger.warning(
                    f"Provenance-wrapped generation failed for cluster {cluster_id}: {e}"
                )
