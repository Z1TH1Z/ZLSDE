...
def validate_modality(modality: str) -> None:
    ...
    if modality not in valid_modalities:
        raise ValueError(f"Invalid modality: {modality}. " f"Must be one of {valid_modalities}")
...
def validate_device(device: str) -> None:
    ...
    if device not in valid_devices:
        raise ValueError(f"Invalid device: {device}. " f"Must be one of {valid_devices}")
...
def validate_clustering_method(method: str) -> None:
    ...
    if method not in valid_methods:
        raise ValueError(f"Invalid clustering method: {method}. " f"Must be one of {valid_methods}")
...
def validate_output_format(format: str) -> None:
    ...
    if format not in valid_formats:
        raise ValueError(f"Invalid output format: {format}. " f"Must be one of {valid_formats}")
