...
from zlsde import PipelineOrchestrator, PipelineConfig, DataSource
...
def main():
    ...
    print(f"Dimensionality reduction: {config.use_dimensionality_reduction} "
    ...
    if result.status == "completed":
        ...
        print(f"Quality: {result.final_metrics.quality_mean:.3f} ± {result.final_metrics.quality_std:.3f}")
